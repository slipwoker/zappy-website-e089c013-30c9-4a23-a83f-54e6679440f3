  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          let errorBanner = contactForm.querySelector('.form-submit-error');
          if (!errorBanner) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מטפים אש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e089c013-30c9-4a23-a83f-54e6679440f3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e089c013-30c9-4a23-a83f-54e6679440f3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e089c013-30c9-4a23-a83f-54e6679440f3';
